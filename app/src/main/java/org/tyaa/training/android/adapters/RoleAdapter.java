package org.tyaa.training.android.adapters;
...
public class RoleAdapter extends ArrayAdapter<RoleModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.roleIdTextView.setText(String.format("id: %s", roleModel.id));
        holder.roleNameTextView.setText(String.format("role name: %s", roleModel.name));
        return convertView;
    }
}
